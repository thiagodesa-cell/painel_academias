...
# --- Lógica de Exibição por Dia da Semana com GIFs Estáveis ---
...
if dia_escolhido == "Segunda-feira":
    ...
    with st.expander("🏋️ 1. Supino Reto com Halteres"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_supino_reto.gif", width=400, caption="Animação: Supino Reto")
    ...
    with st.expander("🔥 2. Tríceps Pulley"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_triceps_pulley.gif", width=400, caption="Animação: Tríceps Pulley")
    ...
    with st.expander("🏋️ 1. Agachamento Livre"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_agachamento_livre.gif", width=400, caption="Animação: Agachamento Livre")
        
    with st.expander("🔥 2. Cadeira Extensora"):
        st.write("**Séries:** 3 de 12 repetições (com Drop-set)")
        st.write("**Foco:** Quadríceps isolado")
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_cadeira_extensora.gif", width=400, caption="Animação: Cadeira Extensora")
    ...
    with st.expander("🏋️ 1. Puxada Alta Frontal"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_puxada_alta.gif", width=400, caption="Animação: Puxada Alta")
        
    with st.expander("🔥 2. Rosca Direta com Barra W"):
        st.write("**Séries:** 4 de 12 repetições")
        st.write("**Foco:** Bíceps")
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_rosca_direta.gif", width=400, caption="Animação: Rosca Direta")
    ...
    with st.expander("🏋️ 1. Desenvolvimento com Halteres"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_desenvolvimento.gif", width=400, caption="Animação: Desenvolvimento")
        
    with st.expander("🔥 2. Prancha Abdominal"):
        st.write("**Séries:** 3 séries de 45 segundos")
        st.write("**Foco:** Core e Abdômen")
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_prancha.gif", width=400, caption="Animação: Prancha Abdominal")
    ...
    with st.expander("🏋️ 1. Stiff com Barra"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_stiff.gif", width=400, caption="Animação: Stiff com Barra")
        
    with st.expander("🔥 2. Cadeira Flexora"):
        st.write("**Séries:** 3 de 12 repetições")
        st.write("**Foco:** Posterior de coxa")
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_cadeira_flexora.gif", width=400, caption="Animação: Cadeira Flexora")
    ...
    with st.expander("🏃 1. Burpees"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_burpee.gif", width=400, caption="Animação: Burpee")
        
    with st.expander("🔥 2. Pular Corda"):
        st.write("**Séries:** 4 rounds de 1 minuto")
        st.write("**Foco:** Resistência e Panturrilhas")
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_pular_corda.gif", width=400, caption="Animação: Pular Corda")
    ...
    with st.expander("🧘 1. Alongamento Global"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_alongamento.gif", width=400, caption="Animação: Alongamento")
    ...
    with st.expander("🚶 2. Caminhada Leve (Opcional)"):
        ...
        st.image("https://images.tcdn.com.br/img/img_prod/1083984/gif_caminhada.gif", width=400, caption="Animação: Caminhada")
