...
# --- Lógica de Exibição por Dia da Semana com GIFs Animados Validados ---
...
if dia_escolhido == "Segunda-feira":
    ...
    with st.expander("🏋️ 1. Supino Reto com Halteres"):
        ...
        st.image("https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=600&auto=format&fit=crop&q=60", width=400, caption="Execução: Supino Reto")
    ...
    with st.expander("🔥 2. Tríceps Pulley"):
        ...
        st.image("https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=600&auto=format&fit=crop&q=60", caption="Execução: Tríceps Pulley")
    ...
    with st.expander("🏋️ 1. Agachamento Livre"):
        ...
        st.image("https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=600&auto=format&fit=crop&q=60", caption="Execução: Agachamento Livre")
        
    with st.expander("🔥 2. Cadeira Extensora"):
        st.write("**Séries:** 3 de 12 repetições (com Drop-set)")
        st.write("**Foco:** Quadríceps isolado")
        st.image("https://images.unsplash.com/photo-1534367507873-d2d7e24c797f?w=600&auto=format&fit=crop&q=60", caption="Execução: Cadeira Extensora")
    ...
    with st.expander("🏋️ 1. Puxada Alta Frontal"):
        ...
        st.image("https://images.unsplash.com/photo-1605296867304-46d5465a13f1?w=600&auto=format&fit=crop&q=60", caption="Execução: Puxada Alta")
        
    with st.expander("🔥 2. Rosca Direta com Barra W"):
        st.write("**Séries:** 4 de 12 repetições")
        st.write("**Foco:** Bíceps")
        st.image("https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=600&auto=format&fit=crop&q=60", caption="Execução: Rosca Direta")
    ...
    with st.expander("🏋️ 1. Desenvolvimento com Halteres"):
        ...
        st.image("https://images.unsplash.com/photo-1532029835096-16e0369c4f7b?w=600&auto=format&fit=crop&q=60", caption="Execução: Desenvolvimento")
        
    with st.expander("🔥 2. Prancha Abdominal"):
        st.write("**Séries:** 3 séries de 45 segundos")
        st.write("**Foco:** Core e Abdômen")
        st.image("https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=600&auto=format&fit=crop&q=60", caption="Execução: Prancha")
    ...
    with st.expander("🏋️ 1. Stiff com Barra"):
        ...
        st.image("https://images.unsplash.com/photo-1566241142559-40e1dab266c6?w=600&auto=format&fit=crop&q=60", caption="Execução: Stiff")
        
    with st.expander("🔥 2. Cadeira Flexora"):
        st.write("**Séries:** 3 de 12 repetições")
        st.write("**Foco:** Posterior de coxa")
        st.image("https://images.unsplash.com/photo-1534367507873-d2d7e24c797f?w=600&auto=format&fit=crop&q=60", caption="Execução: Cadeira Flexora")
    ...
    with st.expander("🏃 1. Burpees"):
        ...
        st.image("https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=600&auto=format&fit=crop&q=60", caption="Execução: Burpee")
        
    with st.expander("🔥 2. Pular Corda"):
        st.write("**Séries:** 4 rounds de 1 minuto")
        st.write("**Foco:** Resistência e Panturrilhas")
        st.image("https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=600&auto=format&fit=crop&q=60", caption="Execução: Pular Corda")
    ...
    with st.expander("🧘 1. Alongamento Global"):
        ...
        st.image("https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600&auto=format&fit=crop&q=60", caption="Execução: Alongamento")
    ...
    with st.expander("🚶 2. Caminhada Leve (Opcional)"):
        ...
        st.image("https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=600&auto=format&fit=crop&q=60", caption="Execução: Caminhada")
